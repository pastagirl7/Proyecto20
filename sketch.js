...
function createCash() {
  if (World.frameCount % 200 == 0) {
   ...
   var cash = createSprite(width-50,height-300,40,10);
    cash.y = Math.round(random(100,220));
...
function createDiamonds() {
  if (World.frameCount % 320 == 0) {
    ...
    var diamonds = createSprite(width-100,height-300,40,10);
    diamonds.y = Math.round(random(100,220));
